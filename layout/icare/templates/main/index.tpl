...
<div id="content">
<div id="topcont">
    <div id="submenubanner" class="ui tertiary inverted red segment">
            ...
            <div class="sx">
                <div class="ada-column">
                    <!-- <div class="portlet">
                        ...
                        <template_field class="template_field_disabled" name="message">message</template_field>
                    </div>
                    -->
                    <div class="portlet">
...
-->
		<div class="helpcont ada-column">
                    <div class="portlet">
                        <div class="portlet-header">ATTENZIONE!</div>
                    <div class="portlet-content">
