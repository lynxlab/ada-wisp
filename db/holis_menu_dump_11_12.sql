...
--
-- Host: localhost
-- Generation Time: Dic 11, 2014 alle 11:08
...
(192, 'modules/lex', 'view.php', 3, 0, 0, NULL);
...
--
ALTER TABLE `menu_page`
MODIFY `tree_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id of the menu tree for the given module, script, user_type and self instruction',AUTO_INCREMENT=193;
...
(165, 'stampa', NULL, 'print', NULL, '{"onclick":"javascript: window.print();"}', NULL, NULL, NULL, NULL, 0, 0, 0, '%ALWAYS%'),
(159, 'repository', NULL, 'share', NULL, NULL, '%HTTP_ROOT_DIR%/browsing', 'mylog.php', NULL, NULL, 0, 0, 5, '%IS_MAGISTRATE%'),
(160, 'esporta', NULL, 'download disk', NULL, NULL, '%HTTP_ROOT_DIR%/browsing', 'mylog.php?op=export', NULL, NULL, 0, 0, 40, '%ALWAYS%'),
...
(166, 'Copia in repository', NULL, 'copy', NULL, '{"onclick":"javascript: copyAssetInMyLog();"}', NULL, NULL, NULL, NULL, 0, 0, 0, '%ALWAYS%'),
(167, 'stampa', NULL, 'print', NULL, '{"target":"_blank"}', '%HTTP_ROOT_DIR%/browsing', 'mylog_print.php', NULL, NULL, 0, 0, 0, '%ALWAYS%');
