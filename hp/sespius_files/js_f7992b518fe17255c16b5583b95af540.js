...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number(($n!=1)); }, 'strings': { "Operations": "Operazioni", "Search": "Cerca", "Delete": "Elimina", "Reset": "Pulisci", "Edit": "Modifica", "file": "file", "Select all rows in this table": "Seleziona tutte le righe in questa tabella", "Deselect all rows in this table": "Deseleziona tutte le righe in questa tabella", "Size": "Dimensione", "Unspecified error": "Errore non specificato", "Join summary": "Unisci il sommario", "Split summary at cursor": "Dividi il sommario nella posizione del cursore", "An HTTP error @status occurred. \n@uri": "Si è verificato un errore HTTP @status. \r\n@uri", "Drag to re-order": "Trascina per riordinare", "Changes made in this table will not be saved until the form is submitted.": "I cambiamenti fatti a questa tabella non saranno salvati finchè il form non viene inviato.", "An error occurred. \n@uri\n@text": "Si è verificato un errore. \r\n@uri\r\n@text", "An error occurred. \n@uri\n(no information available).": "Si è verificato un errore. \r\n@uri\r\n(nessuna informazione disponibile).", "jQuery UI Tabs: Not enough arguments to add tab.": "UI Schede jQuery: non ci sono argomenti a sufficienza per aggiungere una scheda.", "jQuery UI Tabs: Mismatching fragment identifier.": "UI Schede jQuery: indentificatore frammenti discrepanti.", "The changes to these blocks will not be saved until the \x3cem\x3eSave blocks\x3c/em\x3e button is clicked.": "I cambiamenti a questi blocchi non saranno salvati finché il bottone \x3cem\x3eSalva blocchi\x3c/em\x3e è cliccato.", "Down": "Giù", "Up": "Su", "File": "File", "Link": "Link", "Your system configuration does not currently support this feature. The \x3ca href=\"http://drupal.org/node/15365\"\x3ehandbook page on Clean URLs\x3c/a\x3e has additional troubleshooting information.": "La configurazione del vostro sistema attualmente non supporta questa funzione. La pagina del \x3ca href=\"http://drupal.org/node/15365\"\x3emanuale sugli URL semplificati\x3c/a\x3e contiene informazioni aggiuntive per la soluzione dei problemi.", "Testing clean URLs...": "Controllo degli URL semplificati in corso...", "Your server has been successfully tested to support this feature.": "Il vostro server ha superato con successo il test per supportare questa funzione.", "language": "lingua", "An error occurred at @path.": "Si è verificato un errore in @path." } };;
...
function initMenus() {
	var menu, menus, lis, liCorrenteMenus;
	if(document.getElementById && document.getElementsByTagName){
			menus = document.getElementsByTagName("ul");
			if(menus.length > 0 ){
				for(var j=0; j<menus.length; j++){
					if(menus[j].className.match(classeMenu)){
						menu = menus[j];
						lis = menu.getElementsByTagName("li");
						for(var i=0; i<lis.length; i++){
							liCorrenteMenus = lis[i].getElementsByTagName("ul");
							if(liCorrenteMenus.length > 0){
								// a un sous-menu
								addEvent(lis[i],"mouseover", mostraMenu);
								addEvent(lis[i],"focus", mostraMenu);
								addEvent(lis[i],"mouseout", nascondiMenu);	
								addEvent(lis[i],"blur", nascondiMenu);	
							}
						}
					} 
				}
...
$(document).ready(function(){
		...
		$('li.megamenu-li-first').hover(
			function() { 
	  		$('li#'+this.id+' a.megamenu-li-first').addClass('menuattivo'); 
		  	$('li#'+this.id+'>.body-centrale').show(); 

		  },
			function() {
			  $('li#'+this.id+'>.body-centrale').hide(); 
  			$('li.megamenu-li-first a.megamenu-li-first').removeClass('menuattivo'); 
      });

		$('li.megamenu-li-first>.body-centrale').hover(
			function() { 
	  		$('li#'+this.id+' a.megamenu-li-first').addClass('menuattivo'); 
		  },
			function() {
