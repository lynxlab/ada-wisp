   ...
   *
    */
    ...
    public function get_published_courses($id_tester=null) {
        ...
        $courses_sql = 'SELECT S.id_servizio, S.nome, S.descrizione, S.durata_servizio, S.livello FROM servizio AS S '.
...
//    return $res_ar;
    ...
    public function get_course_instances_for_this_student($id_student, $extra_fields=false) {
        ...
        if ($extra_fields) {
            $sql .= ' ,IC.title,I.data_iscrizione,IC.duration_subscription, C.tipo_servizio, IC.status as instance_status, IC.self_instruction, IC.tipo_servizio as `istanza_tipo_servizio`';
        }
    ...
    public function &get_tutors_assigned_course_instance($id_tutor = false, $id_course = false, $isSuper = false) {
        ...
        $sql = "SELECT ".
					...
					i.`id_istanza_corso`, i.`title`,i.`data_inizio_previsto`,i.`data_fine`,i.`duration_hours`,
                                        i.`durata`,i.`self_instruction`,i.`data_inizio`,c.`tipo_servizio`
				FROM ".
...
//    return $user_id;
   ...
   */
    ...
    public function get_tutors_for_student($id_student) {
        ...
        $sql = "SELECT U.tipo, U.username, U.nome, U.cognome, U.avatar, U.id_utente FROM utente AS U, iscrizioni AS I, tutor_studenti AS T
