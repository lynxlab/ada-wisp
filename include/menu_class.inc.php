    ...
    public function __construct($module, $script, $user_type, $menuoptions) {
    	 ...
    	 */
     	if (isset($_SESSION['sess_userObj']) && $_SESSION['sess_userObj'] instanceof ADALoggableUser &&
     			...
     			$_SESSION['sess_userObj']->getType()==AMA_TYPE_STUDENT &&
     			$_SESSION['sess_userObj']->getSerialNumber()==AMA_TYPE_USER_LAWYER &&
     			!defined('IS_LAWYER')) {
     				define ('IS_LAWYER', true);
     	} else if (isset($_SESSION['sess_userObj']) && $_SESSION['sess_userObj'] instanceof ADALoggableUser &&
     			$_SESSION['sess_userObj']->getType()==AMA_TYPE_STUDENT &&
     			$_SESSION['sess_userObj']->getSerialNumber()==AMA_TYPE_USER_GENERIC &&
     			!defined('IS_GENERIC')) {
     				define ('IS_GENERIC', true);
     	} else if (isset($_SESSION['sess_userObj']) && $_SESSION['sess_userObj'] instanceof ADALoggableUser &&
     			$_SESSION['sess_userObj']->getType()==AMA_TYPE_STUDENT &&
     			$_SESSION['sess_userObj']->getSerialNumber()==AMA_TYPE_USER_AUX &&
     			!defined('IS_AUX')) {
     				define ('IS_AUX', true);
     	}  else if (isset($_SESSION['sess_userObj']) && $_SESSION['sess_userObj'] instanceof ADALoggableUser &&
     			$_SESSION['sess_userObj']->getType()==AMA_TYPE_TUTOR &&
     			!defined('IS_TUTOR')) {
     				define ('IS_TUTOR', true);
     	}  else if (isset($_SESSION['sess_userObj']) && $_SESSION['sess_userObj'] instanceof ADALoggableUser &&
     			$_SESSION['sess_userObj']->getType()==AMA_TYPE_AUTHOR &&
     			!defined('IS_AUTHOR')) {
